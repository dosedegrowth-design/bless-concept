...
const IMAGE_SLOTS: ImageSlot[] = [
  ...
  {
    id: "noivas-hero",
    label: "Noivas — Hero (tela cheia)",
    category: "Página Noivas",
    path: "public/images/noivas/noivas-hero.webp",
    description: "Foto fullscreen para o topo da página de noivas. Noiva sendo produzida ou espaço com vestido.",
    size: "1920 x 1080 px",
    ratio: "16:9 (paisagem)",
    type: "image",
  },
  {
    id: "noivas-kate",
    label: "Noivas — Experiência Kate Middleton",
    category: "Página Noivas",
    path: "public/images/noivas/experiencia-kate.webp",
    description: "Foto representando elegância clássica. Noiva arrumando cabelo, prova de maquiagem, ou ambiente sofisticado.",
    size: "800 x 1000 px",
    ratio: "4:5 (retrato)",
    type: "image",
  },
  {
    id: "noivas-diana",
    label: "Noivas — Experiência Lady Diana",
    category: "Página Noivas",
    path: "public/images/noivas/experiencia-diana.webp",
    description: "Foto delicada e acolhedora. Noiva sorrindo, buquê, momento emocional.",
    size: "800 x 1000 px",
    ratio: "4:5 (retrato)",
    type: "image",
  },
  {
    id: "noivas-elizabeth",
    label: "Noivas — Experiência Rainha Elizabeth",
    category: "Página Noivas",
    path: "public/images/noivas/experiencia-elizabeth.webp",
    description: "Foto de luxo e exclusividade. Noiva em espelho, detalhes premium, ambiente VIP.",
    size: "800 x 1000 px",
    ratio: "4:5 (retrato)",
    type: "image",
  },
  {
    id: "noivas-galeria-01",
    label: "Noivas — Galeria 1",
    category: "Página Noivas",
    path: "public/images/noivas/galeria-01.webp",
    description: "Foto de noiva — preparação ou resultado",
    size: "600 x 800 px",
    ratio: "3:4 (retrato)",
    type: "image",
  },
  {
    id: "noivas-galeria-02",
    label: "Noivas — Galeria 2",
    category: "Página Noivas",
    path: "public/images/noivas/galeria-02.webp",
    description: "Foto de noiva — detalhes (cabelo, maquiagem, acessório)",
    size: "600 x 800 px",
    ratio: "3:4 (retrato)",
    type: "image",
  },
  {
    id: "noivas-galeria-03",
    label: "Noivas — Galeria 3",
    category: "Página Noivas",
    path: "public/images/noivas/galeria-03.webp",
    description: "Foto de noiva — momento emocional",
    size: "600 x 800 px",
    ratio: "3:4 (retrato)",
    type: "image",
  },
  {
    id: "noivas-galeria-04",
    label: "Noivas — Galeria 4",
    category: "Página Noivas",
    path: "public/images/noivas/galeria-04.webp",
    description: "Foto de noiva — espaço ou produção",
    size: "600 x 800 px",
    ratio: "3:4 (retrato)",
    type: "image",
  },
  {
    id: "noivas-galeria-05",
    label: "Noivas — Galeria 5",
    category: "Página Noivas",
    path: "public/images/noivas/galeria-05.webp",
    description: "Foto de noiva — resultado final",
    size: "600 x 800 px",
    ratio: "3:4 (retrato)",
    type: "image",
  },
  {
    id: "noivas-galeria-06",
    label: "Noivas — Galeria 6",
    category: "Página Noivas",
    path: "public/images/noivas/galeria-06.webp",
    description: "Foto de noiva — vestido ou ambiente",
    size: "600 x 800 px",
    ratio: "3:4 (retrato)",
    type: "image",
  },
  {
    id: "noivas-cta",
    label: "Noivas — CTA Final (fundo)",
    category: "Página Noivas",
    path: "public/images/noivas/noivas-cta.webp",
    description: "Foto de fundo para a seção final da página de noivas. Ambiente premium ou detalhes.",
    size: "1920 x 800 px",
    ratio: "~2.4:1 (paisagem larga)",
    type: "image",
  },
